...
- Expected delivery: 5–7 business days (domestic). International orders may take longer - final delivery timeline will be confirmed via WhatsApp.`;
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="sticky bottom-0 bg-white pt-3 pb-1 border-t border-border-brand/30 -mx-0">
        <button
          type="submit"
          className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-3.5 px-4 rounded-xl font-bold transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.01]"
